"""
Django settings for user_otp project.
...
SECRET_KEY = 'django-insecure-y8o&cv^rkt(ned5fz8h1&s%_idsc6w(alzuveki)f1t%b%@&fz'
...
WSGI_APPLICATION = 'user_otp.wsgi.application'
